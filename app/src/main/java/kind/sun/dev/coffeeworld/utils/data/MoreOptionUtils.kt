...
class MoreOptionUtils {
    ...
    companion object {
        ...
        fun getMoreOptions(): List<MoreViewItem> {
            return mutableListOf<MoreViewItem>().apply {
                ...
                add(
                    MoreViewItem.Item(
                        ...
                        R.string.terms_and_conditions, MoreViewItem.BOX_ONLY_TYPE
                    )
                )
                ...
                add(
                    MoreViewItem.Item(
                        ...
                        R.string.explore, MoreViewItem.BOX_DOUBLE_TYPE
                    )
                )
                add(
                    MoreViewItem.Item(
                        Id.HUNTER_FOR_DEALS, R.drawable.ic_baseline_price_change_24,
                        R.string.hunt_for_deals, MoreViewItem.BOX_DOUBLE_TYPE
                    )
                )
                ...
                add(
                    MoreViewItem.Item(
                        ...
                        R.string.order_reviews, MoreViewItem.ROW_TYPE
                    )
                )
                add(
                    MoreViewItem.Item(
                        Id.CONTACT_AND_FEEDBACK, R.drawable.ic_baseline_message_24,
                        R.string.contact_and_feedback, MoreViewItem.ROW_TYPE
                    )
                )
                ...
                add(
                    MoreViewItem.Item(
                        ...
                        R.string.user, MoreViewItem.ROW_TYPE
                    )
                )
                add(
                    MoreViewItem.Item(
                        Id.SECURITY, R.drawable.ic_baseline_security_24,
                        R.string.security, MoreViewItem.ROW_TYPE
                    )
                )
                add(
                    MoreViewItem.Item(
                        Id.SETTINGS, R.drawable.ic_baseline_settings_24,
                        R.string.settings, MoreViewItem.ROW_TYPE
                    )
                )
                add(
                    MoreViewItem.Item(
                        Id.PAYMENT, R.drawable.ic_baseline_payment_24,
                        R.string.payment, MoreViewItem.ROW_TYPE
                    )
                )
            }
        }
